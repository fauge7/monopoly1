...
public class GameState extends State{
	...
	public GameState(StateManager manager, SpriteBatch batch , int numPlayers){
		...
		gameBoard = new Texture(Gdx.files.internal("assets/gameboard.png"));
		rollUp = new Texture(Gdx.files.internal("assets/roll_up.png"));
		rollDown = new Texture(Gdx.files.internal("assets/roll_down.png"));
		endTurnUp = new Texture(Gdx.files.internal("assets/endturn_up.png"));
		endTurnDown = new Texture(Gdx.files.internal("assets/endturn_down.png"));
		tradeUp = new Texture(Gdx.files.internal("assets/trade_up.png"));
		tradeDown = new Texture(Gdx.files.internal("assets/trade_down.png"));
		mortgageUp = new Texture(Gdx.files.internal("assets/mortgage_up.png"));
		mortgageDown = new Texture(Gdx.files.internal("assets/mortgage_down.png"));
		upgradeUp = new Texture(Gdx.files.internal("assets/upgrade_up.png"));
		upgradeDown = new Texture(Gdx.files.internal("assets/upgrade_down.png"));
		payBailUp = new Texture(Gdx.files.internal("assets/paybail_up.png"));
		payBailDown = new Texture(Gdx.files.internal("assets/paybail_down.png"));
		dog = new Texture(Gdx.files.internal("assets/dog.png"));
		car = new Texture(Gdx.files.internal("assets/car.png"));
		iron = new Texture(Gdx.files.internal("assets/iron.png"));
		boot = new Texture(Gdx.files.internal("assets/boot.png"));
		dogIcon = new Texture(Gdx.files.internal("assets/dog_icon.png"));
		carIcon = new Texture(Gdx.files.internal("assets/car_icon.png"));
		ironIcon = new Texture(Gdx.files.internal("assets/iron_icon.png"));
		bootIcon = new Texture(Gdx.files.internal("assets/boot_icon.png"));
		dogOwnedVert = new Texture(Gdx.files.internal("assets/dog_owned_vert.png"));
		dogOwnedHoriz = new Texture(Gdx.files.internal("assets/dog_owned_horiz.png"));
		carOwnedVert = new Texture(Gdx.files.internal("assets/car_owned_vert.png"));
		carOwnedHoriz = new Texture(Gdx.files.internal("assets/car_owned_horiz.png"));
		ironOwnedVert = new Texture(Gdx.files.internal("assets/iron_owned_vert.png"));
		ironOwnedHoriz = new Texture(Gdx.files.internal("assets/iron_owned_horiz.png"));
		bootOwnedVert = new Texture(Gdx.files.internal("assets/boot_owned_vert.png"));
		bootOwnedHoriz = new Texture(Gdx.files.internal("assets/boot_owned_horiz.png"));
